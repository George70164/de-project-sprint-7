...
events_datamart = SparkSubmitOperator(
    ...
    application_args=["2022-01-02",
                      ...
                      "/user/gera190770/data/geo/geo_time_zone.csv",
                      "/user/gera190770/analytics/user_datamart"],
    conf={
...
geolayer_datamart = SparkSubmitOperator(
    ...
    application_args=["2022-01-02",
                      "/user/master/data/geo/events",
                      "/user/gera190770/data/geo/geo_time_zone.csv",
                      "/user/gera190770/analytics/geolayer_datamart"],
    conf={
        "spark.driver.maxResultSize": "20g"
    },
    executor_cores=2,
...
friends_datamart = SparkSubmitOperator(
    ...
    application_args=["2022-01-02",
                      "/user/master/data/geo/events",
                      "/user/gera190770/data/geo/geo_time_zone.csv",
                      "/user/gera190770/analytics/friends_datamart"],
    conf={
        "spark.driver.maxResultSize": "20g"
    },
    executor_cores=2,
